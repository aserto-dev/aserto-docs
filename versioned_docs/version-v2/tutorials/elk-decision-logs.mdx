...
- A tenant id, which can be found in [policy settings](../aserto-console/view-policies#viewing-policy-settings)
- A [decision logs API key](../aserto-console/decision-logs#decision-logs-api-key)
