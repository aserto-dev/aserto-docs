...
From here, make sure you consult the `README`. Specifically, you also need to instantiate an Aserto policy before you can run `yarn start:all` to run the app. To do that, skip to this [step](create-a-policy).
:::
