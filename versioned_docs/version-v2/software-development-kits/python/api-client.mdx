...
This package provides a high-level interface for interacting with the Aserto [Authorizer](../../apis/authorizer/overview) API.
...
- `resource_context` (_required_): The [resource context](../../apis/authorizer/resource-context) provided to the Authorizer as a serializable `dict`
