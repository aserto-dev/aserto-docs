...
- A connection to an [Identity Provider](../aserto-console/connections/overview)
- An Aserto [Policy](../tutorials/create-policy/overview.mdx)
...
To add authentication to your backend application, first you need to create an Aserto [policy](../architecture/policy/overview) that contains the authentication rules for the APIs provided by the application.
