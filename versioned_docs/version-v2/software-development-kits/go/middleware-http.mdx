...
Creating middleware requires two arguments: an [authorizer client](authorizer),
...
[Identity](../../apis/authorizer/identity-context) information is set on the middleware's `.Identity`.
...
[Resource](../../apis/authorizer/resource-context) information can be added to authorization requests using
`.WithResourceMapper()`:
