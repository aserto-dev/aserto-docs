...
[`AuthorizerClient`](https://github.com/aserto-dev/aserto-java/blob/98e155e0305d14685256b2bde0d14e4b58f1bc75/src/main/java/com/aserto/AuthorizerClient.java#L13) is an abstraction over the raw grpc bindings that talks to the Aserto [authorization API](../../apis/authorizer/authz).
