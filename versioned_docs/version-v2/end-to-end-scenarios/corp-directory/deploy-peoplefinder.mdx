...
An identity provider is the source of truth for user and group information. Aserto can pull user and group information out of an identity provider and into the Aserto [Directory](../../architecture/directory), so you can use these users, groups, and relationships between them in your authorization decisions.
