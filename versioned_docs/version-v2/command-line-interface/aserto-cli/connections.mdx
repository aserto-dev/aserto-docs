...
Aserto manages [connections](../../architecture/connections) to source code providers and identity providers.
...
To discover the types of connections Aserto supports (known as [Providers](../../architecture/connections#providers)),
use the following:
