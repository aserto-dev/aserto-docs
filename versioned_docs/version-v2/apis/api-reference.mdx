...
If you'd like a conceptual overview of Aserto before diving into the APIs, start with the [introduction](docs/v1/overview/introduction).
...
For an overview of the Aserto Authorizer APIs, start with the [Authorizer Guide](docs/v1/authorizer-guide/overview).
