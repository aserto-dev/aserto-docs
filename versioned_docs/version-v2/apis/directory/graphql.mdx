...
You can view the Directory GraphQL API documentation in the [GraphQL Playground](https://directory.eng.aserto.com/graph#). If you have an Aserto account, you can also access the Playground from within the [Aserto Console](../../aserto-console/directory/graphql-playground)

### Schema documentation

Launch the stand-alone [Playground](https://directory.eng.aserto.com/graph#). This is ideal for quickly exploring the API documentation.
