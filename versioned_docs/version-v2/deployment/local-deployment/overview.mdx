...
The [Edge Authorizers](/docs/architecture/authorizer/edge-authorizer/overview) documentation describes the Sidecar and its deployment and management in more detail.
