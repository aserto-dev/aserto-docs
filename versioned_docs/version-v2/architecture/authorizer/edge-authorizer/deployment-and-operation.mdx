...
To configure the sidecar to connect to the Aserto control plane, use the following command. Note that EDGE_AUTHORIZER_CONNECTION_ID is the connection ID of an edge authorizer that you [created in the Aserto console](../../../aserto-console/connections/setup-edge). 
