...
title: Architecture - Policy - Overview
description: The Aserto Authorization Policy - an Overview
---

# Policy

Aserto Policies are a collection of rules that govern access to the resources within an application. At runtime, Aserto uses Policies to determine whether or not to allow a caller to access resources. 

A Policy contains a collection of _Policy Modules_ which are authored in a declarative language called
