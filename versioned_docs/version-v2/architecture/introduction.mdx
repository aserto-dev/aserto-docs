...
The [Authorizer](authorizer/overview) is an open source authorization engine which uses the 
...
[Directory](directory), which is inherits its design from Google's 
[Zanzibar](https://research.google/pubs/pub48190/) system. 

## Control Plane

The Aserto [Control Plane](control-plane) manages the lifecycle of **policies**, 
