...
Life cycle metadata is represented by the [`Lifecycle`](schema/common/objects/lifecycle) type, and can be retrieved from
directory items with `lifecycle` property (e.g. [`Object.lifecycle`](schema/objects/objects/object#lifecycle-lifecycle)).
