...
Aserto manages [connections](/docs/v1/overview/connections) to source code providers and identity providers.
...
To discover the types of connections Aserto supports (known as [Providers](/docs/v1/overview/connections#providers)),
use the following:
