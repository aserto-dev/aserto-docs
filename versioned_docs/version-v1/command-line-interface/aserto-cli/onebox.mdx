...
The Sidecar can be connected to the Aserto control plane. This enables additional functionality, including the ability to issue commands to the Sidecar remotely. To connect the Sidecar to the Aserto control plane see the [edge authorizers](/docs/v1/edge-authorizers/security-and-management) section.