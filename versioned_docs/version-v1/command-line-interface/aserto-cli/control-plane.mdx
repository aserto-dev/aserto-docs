...
Aserto [edge authorizers](/docs/v1/edge-authorizers/overview) can connect to the Aserto control plane to receive policy and
...
authorizers](/docs/v1/edge-authorizers/security-and-management) section of this documentation.
