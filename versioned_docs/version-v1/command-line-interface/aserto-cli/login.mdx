...
title: Signing in to the Aserto CLI
description: Signing in/out to/from Aserto CLI
---
...
This command returns the [organizations](/docs/v1/overview/organization) the current account is registered with. It also returns
the default tenant.
