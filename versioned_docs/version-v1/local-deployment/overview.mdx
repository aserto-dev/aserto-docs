...
The [Edge Authorizers](/docs/v1/edge-authorizers/overview) documentation describes the Sidecar and its deployment and management in more detail.
...
The [Local Directory](local-directory/overview) documentation describes the scenarios where running a separate directory is advantageous, and how to deploy it in your local Kubernetes environment.
