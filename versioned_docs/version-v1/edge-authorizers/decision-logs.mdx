...
[connection](/docs/v1/edge-authorizers/security-and-management#edge-authorizer-connections) used to connect to the control
plane.
...
management](/docs/v1/edge-authorizers/security-and-management#configuration) section for configuration details.
- The policy it loads must have decision logs enabled. See the [decision logs
guide](/docs/v1/decision-logs-guide/console) for details on how to enable decision logs
for a policy.
