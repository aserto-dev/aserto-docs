...
[Aserto Directory API](/docs/v1/directory-api-reference/overview).
...
[authentication](/docs/v1/directory-api-reference/overview#authentication) headers in your requests.
:::
