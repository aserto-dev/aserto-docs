...
See [SetObjectInput](/docs/v1/directory-api-reference/schema/objects/inputs/set-object-input) for more details on the input fields.

## Querying Objects

We use the [objects](/docs/v1/directory-api-reference/schema/objects/queries/objects) query to find the department objects we
just created.
...
We used the `where` parameter in the [objects](/docs/v1/directory-api-reference/schema/objects/queries/objects) query to only
