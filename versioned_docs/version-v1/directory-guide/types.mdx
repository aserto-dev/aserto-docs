...
We use the [`setObjectType`](/docs/v1/directory-api-reference/schema/object-types/mutations/set-object-type) mutation to create a new
...
The input fields are described in more detail [here](/docs/v1/directory-api-reference/schema/object-types/inputs/set-object-type-input).

### Querying Object Types

To see that the department object types was indeed created, we can enumerate object types using the
[objectTypes](/docs/v1/directory-api-reference/schema/object-types/queries/object-types) query.
...
[here](/docs/v1/directory-api-reference/schema/relation-types/inputs/set-relation-type-input).
