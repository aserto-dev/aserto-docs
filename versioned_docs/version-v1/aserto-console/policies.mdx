...
The underpinning of Aserto's authorization model is the [policy](/docs/v1/overview/policy).
...
If you choose to create a policy from a template, you'll be asked to select a connection to a source code control system. If you don't have any yet, follow the instructions to [create one](/docs/v1/aserto-console/connections/overview).
...
Click the "Link a source code repository" button. First, you'll be asked to select your source code provider. If you don't have any yet, follow the instructions to [create one](/docs/v1/aserto-console/connections/overview).
