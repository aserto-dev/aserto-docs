...
Creating middleware requires two arguments: an [authorizer client](/docs/v1/software-development-kits/go/authorizer),
...
[Identity](/docs/v1/authorizer-guide/identity-context) information is set on the middleware's `.Identity`.
...
[Resource](/docs/v1/authorizer-guide/resource-context) information can be added to authorization requests using
`.WithResourceMapper()`:
