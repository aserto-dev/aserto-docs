...
- A connection to an [Identity Provider](/docs/v1/aserto-console/connections/overview)
- An Aserto [authorization policy](/docs/v1/getting-started/peoplefinder/create-policy)
...
To add authentication to your backend application, first you need to create an Aserto [policy](/docs/v1/overview/policy) that contains the authentication rules for the APIs provided by the application.
