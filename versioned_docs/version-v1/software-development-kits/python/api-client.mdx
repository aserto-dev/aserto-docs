...
This package provides a high-level interface for interacting with the Aserto [Authorizer](/docs/v1/authorizer-guide/overview) API.
...
- `identity` (_required_): An `Identity` instance that represents a user.
  Refer to the [aserto-idp](/docs/v1/software-development-kits/python/identity-providers) package
...
- `resource_context` (_required_): The [resource context](/docs/v1/authorizer-guide/resource-context) provided to the Authorizer as a serializable `dict`
