...
To follow this Quickstart you'll need to have an Aserto account. If you do not have one, you can create one following the directions [here](/docs/v1/getting-started/first-steps/create-account). Once you have created your tenant, you can continue.
