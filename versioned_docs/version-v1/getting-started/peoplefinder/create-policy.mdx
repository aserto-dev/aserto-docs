...
* To connect GitHub using a Personal Access Token (PAT), follow these [instructions](/docs/v1/aserto-console/connections/setup-github#connecting-github-using-a-pat).
* To connect to GitLab using a Personal Access Token (PAT), follow these [instructions](/docs/v1/aserto-console/connections/setup-gitlab).
