...
It is used by the the [**display state map**](/docs/v1/authorizer-guide/display-state-map) middleware in SDKs such as the [Aserto Express.js SDK](/docs/v1/software-development-kits/javascript/express#displaystatemap-middleware), in conjunction with the [Aserto React SDK](/docs/v1/software-development-kits/javascript/react), that is useful in conditionally rendering UI elements based on the **display state** that corresponds to a decision.
...
The `identityContext` map is documented [here](/docs/v1/authorizer-guide/identity-context).

The `policyContext` map is documented [here](/docs/v1/authorizer-guide/policy-context).

The `policyInstance` map is documented [here](/docs/v1/authorizer-guide/policy-instance).

The `resourceContext` map is documented [here](/docs/v1/authorizer-guide/resource-context).
...
To upgrade from the v1 Policy Context, see this [topic](/docs/v1/authorizer-guide/upgrading-from-v1).
