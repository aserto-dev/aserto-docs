...
The [Authorizer](/docs/v1/overview/authorizer) is an open source authorization engine which uses the 
...
[Directory](/docs/v1/overview/directory), which is inherits its design from Google's 
[Zanzibar](https://research.google/pubs/pub48190/) system. 

## Control Plane

The Aserto [Control Plane](/docs/v1/overview/control-plane) manages the lifecycle of **policies**, 
