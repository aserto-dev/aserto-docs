...
description: Connections - types of connections and their purposes
---
...
are three types of user connections currently supported:

- **IDP** (identity provider): this is a read-only connection between Aserto and an Identity Provider. Currently, Auth0, Azure AD, and Okta are supported.
...
Connections are created using the Aserto [Console](/docs/v1/aserto-console/connections/overview). Currently, a tenant
...
by the Aserto [directory](/docs/v1/overview/directory).
