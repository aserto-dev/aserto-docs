...
any identity providers that has been [connected](/docs/v1/overview/connections) to the control plane.  Some identity
...
Policies can reference [user context](/docs/v1/overview/policy#user-context). A calling application can
provide the [identity context](/docs/v1/authorizer-guide/identity-context) which is used to load that user context.
...
Authorization policies can access directory contents via a set of [built-ins](/docs/v1/authorizer-guide/built-ins).
