...
[_connections_](/docs/v1/overview/connections), [_policies_](/docs/v1/overview/policy-lifecycle), and the [_user directory_](/docs/v1/overview/directory). You can think of it like a GitHub organization.
...
- [Connections](/docs/v1/overview/connections) - these are connections to external systems such as source code control systems and identity providers
- [Policies](/docs/v1/overview/policy-lifecycle) - these are references to git repositories that store authorization policies
- [User Directory](/docs/v1/overview/directory) - these are the users that Aserto has synched from one or more connected identity providers
...
Learn more about how to [manage Aserto organizations](/docs/v1/aserto-console/manage-organizations) using the Aserto Console.
