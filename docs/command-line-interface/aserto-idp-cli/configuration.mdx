...
:::note:::
These values should come from a machine-to-machine (M2M) application. To learn how to set one up in Auth0, refer to [this](/docs/getting-started/bring-your-own-idp/set-up-auth0) guide.
:::note
