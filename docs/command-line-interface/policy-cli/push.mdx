...
from your local filesystem to a policy registry (like `apcr` or `opcr.io`):
...
Resolved ref [registry.prod.aserto.com/omrigazitt1/peoplefinder:1.0.0].
digest: sha256:84dbd4e3b5572dd2f23c3c987c89443fdcb57af87d714ea296fc552192fb17e9

Pushed ref [registry.prod.aserto.com/omrigazitt1/peoplefinder:1.0.0].
