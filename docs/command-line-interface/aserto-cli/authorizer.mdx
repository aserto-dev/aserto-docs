...
As the Aserto CLI is based on the Topaz CLI please see documentation available [here](https://www.topaz.sh/docs/command-line-interface/topaz-cli/authorizer)
