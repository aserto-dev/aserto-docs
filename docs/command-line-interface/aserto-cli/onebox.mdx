...
title: Local Developer Experience (OneBox)
description: Using the local developer experience (OneBox) and the Aserto CLI
---
...
The OneBox can be connected to the Aserto control plane. This enables additional functionality, including the ability to
issue commands to the OneBox remotely. To connect the OneBox to the Aserto control plane see the [edge
authorizers](/docs/edge-authorizers/security-and-management) section.