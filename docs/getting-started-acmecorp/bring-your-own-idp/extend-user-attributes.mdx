...
:::tip
Advanced: you can also [side-load](/docs/command-line-interface/aserto-cli/directory#side-loading) users, but we
...
we loaded into Auth0 in the [Set up test users](/docs/getting-started-acmecorp/bring-your-own-idp/set-up-auth0) topic:
