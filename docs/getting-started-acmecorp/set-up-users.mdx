...
title: Set up demo users
description: Set up demo users for PeopleFinder
---
...
<img src="/connections-tab.png" width="500px" />
...
Next, select the "Identity Providers" connection type and select the the `Demo Acmecorp IDP` provider:

![add-acmecorp-connection](/add-acmecorp-connection.png)

Name the provider "acmecorp" and use the display name "Acmecorp."

Finally click “Add connection”:

<img src="/getting-started-acmecorp/add-connection-button.png" width="170px" />
