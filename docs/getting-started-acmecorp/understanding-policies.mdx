...
The Aserto console shows the current loaded policy for the hosted Authorizer instance for your tenant. If you click the `peoplefinder-rbac` instance in the Authorizer tab, you will see the current set of policy modules.
