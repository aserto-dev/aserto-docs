...
The Aserto console shows the current loaded policy version for the policy instance you created. If you click the `peoplefinder-rbac` instance in the Policies tab, you will see the current set of policy modules.
