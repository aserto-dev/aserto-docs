...
So far, we were using a policy created by Aserto. Let’s modify this policy and learn how to update our changes in Aserto. To make changes to the policy, clone the Github repository created in [Part I](/docs/getting-started-acmecorp/setup-aserto#choose-a-source-code-provider) of this tutorial. Open the cloned repository in your favorite IDE.
