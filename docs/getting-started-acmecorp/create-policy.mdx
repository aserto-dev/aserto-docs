...
When you click on "Create a policy repository", you'll be asked to choose between using a policy template and creating an empty policy repository:
...
1. 0 - The _major_ version of the policy. All **minor and patch** versions under this version will be included in this policy. For example, if you create a `0.1` tag, any authorizer instance associated with the `0` tag will reflect the latest minor and patch version change.
2. 0.0 - The _minor_ version of the policy. All **patch** versions under this version will be included in this policy. For example, if you create a `0.0.1` tag, any authorizer instance associated with the `0.0` tag will reflect the latest patch version change.
...
4. latest - Represents the latest version of the policy. An authorizer instance associated with this tag will always reflect the latest tag pushed to the repository.
