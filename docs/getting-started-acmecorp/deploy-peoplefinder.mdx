...
To find your policy configuration information, open the Authorizer tab in [console.aserto.com](https://console.aserto.com/ui/authorizer), and open the `peoplefinder-rbac` instance you created.
