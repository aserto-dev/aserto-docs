...
To find your policy configuration information, open the Policies tab in [console.aserto.com](https://console.aserto.com/ui/policies), and open the `peoplefinder-rbac` instance you created.
