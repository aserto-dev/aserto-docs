...
demo application called [PeopleFinder](https://github.com/aserto-dev/peoplefinder-acmecorp).
...
- Our sample application, [PeopleFinder](https://github.com/aserto-dev/peoplefinder-acmecorp), cloned to your GitHub account
