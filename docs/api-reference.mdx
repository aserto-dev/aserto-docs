...
* [Control Plane](control-plane-guide/overview) - The [Aserto Control Plane](overview/control-plane) is used to manage [Edge Authorizers](/docs/edge-authorizers/overview).
