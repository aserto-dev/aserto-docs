...
## Deploy the edge authorizer as a local container instance

You can deploy the edge authorizer as a local container instance, doing will allow you to locally validate configuring and using the authorizer. 
