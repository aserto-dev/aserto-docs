...
See [SetObjectInput](/docs/directory-api-reference/schema/inputs/set-object-input) for more details on the input fields.

## Querying Objects

We use the [objects](/docs/directory-api-reference/schema/queries/objects) query to find the department objects we
just created.
...
We used the `where` parameter in the [objects](/docs/directory-api-reference/schema/queries/objects) query to only
