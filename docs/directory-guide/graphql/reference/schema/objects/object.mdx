...
#### [`type`](#) ([`ObjectType!`](/docs/directory-guide/graphql/reference/schema/objects/object-type))
...
#### [`relations`](#) ([`RelationConnection!`](/docs/directory-guide/graphql/reference/schema/objects/relation-connection))
...
- ##### [`side`](#) ([`RelationSide!`](/docs/directory-guide/graphql/reference/schema/enums/relation-side))




- ##### [`options`](#) ([`RelationOptions`](/docs/directory-guide/graphql/reference/schema/inputs/relation-options))
