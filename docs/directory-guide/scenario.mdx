...
title: Overview
description: Overview of the multi-tenant RBAC scenario
---

This Quickstart walks through an example scenario and demonstrates how the Aserto Directory can be used to implement
...
* `member`: In addition to viewer privileges, members have permission to view all the data, add new products to the
...
1. Have an Aserto account. If you haven't created one yet, head over to [aserto.com](https://www.aserto.com/) and
   create one now.
1. New accounts already have a connection to the Citadel IDP and will display the five Citadel users.
  If you don't see them, follow the remainder of the steps below.
...
Add HTTP headers in the [GraphiQL Playground](https://directory.prod.aserto.com/graph) as a JSON object in the
"Request Headers" section beneath the code editor.

<img src="/directory/graphiql-headers.png" width="900px" />
