...
To learn more about Aserto's architecture and different moving parts, read through our [conceptual overview](/docs/overview/introduction).
...
- [Authorizer Guide](/docs/authorizer-guide/overview): a description of the Authorization APIs.
- [API Reference](/docs/api-reference): executable documentation for the Aserto APIs.
