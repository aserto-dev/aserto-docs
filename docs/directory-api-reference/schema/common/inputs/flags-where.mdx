...
#### [`equals`](#) ([`[Flag!]`](/docs/directory-api-reference/schema/common/enums/flag))

The type's status is equal to the given flags.


#### [`contains`](#) ([`[Flag!]`](/docs/directory-api-reference/schema/common/enums/flag))

The type's status contains all of the given flags.


#### [`notContains`](#) ([`[Flag!]`](/docs/directory-api-reference/schema/common/enums/flag))
