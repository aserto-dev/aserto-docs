...
#### [`other`](#) ([`ObjectSelector`](/docs/directory-api-reference/schema/objects/inputs/object-selector))

[optional] Only include relations with the specified object ID.


#### [`otherType`](#) ([`ObjectTypeSelector`](/docs/directory-api-reference/schema/object-types/inputs/object-type-selector))
