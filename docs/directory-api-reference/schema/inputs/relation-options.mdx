...
#### [`other`](#) ([`ObjectSelector`](/docs/directory-api-reference/schema/inputs/object-selector))

[optional] Only include relations with the specified object ID.


#### [`otherType`](#) ([`ObjectTypeSelector`](/docs/directory-api-reference/schema/inputs/object-type-selector))
