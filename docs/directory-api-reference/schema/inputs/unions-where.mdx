...
#### [`contains`](#) ([`[RelationTypeSelector]`](/docs/directory-api-reference/schema/inputs/relation-type-selector))

Matches relation types that include all given relation types in their `unions` field.


#### [`notContains`](#) ([`[RelationTypeSelector]`](/docs/directory-api-reference/schema/inputs/relation-type-selector))
