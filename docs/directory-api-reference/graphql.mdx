...
You can view the Directory GraphQL API documentation in the [GraphQL Playground](https://directory.aserto.com/graph#). If you have an Aserto account, you can also access the Playground from within the [Aserto Console](../aserto-console/directory/graphql-playground)
