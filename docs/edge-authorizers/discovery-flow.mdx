...
The configuration will be generated in the directory ` ~/.config/aserto/sidecar/cfg`.
...
```sh
curl --request GET \
     --url https://discovery.prod.aserto.com/api/v1/discovery/policies/<POLICY_ID>/opa/discovery \
