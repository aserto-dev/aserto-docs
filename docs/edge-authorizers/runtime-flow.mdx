...
The runtime configuration is automatically retrieved from the control plane and is not persisted. The example below shows the resolve runtime configuration of the edge authorizer.
