...
To configure an edge authorizer that is connected to the control plane, refer to the [Edge Authorizer](/docs/command-line-interface/aserto-cli/onebox.mdx) documentation.
