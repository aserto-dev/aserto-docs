...
Edge authorizer connections can be created from the Aserto console or API and provide an identity that edge authorizers
...
authorized to establish a connection to the Aserto control plane for the purpose of receiving receive control commands.
