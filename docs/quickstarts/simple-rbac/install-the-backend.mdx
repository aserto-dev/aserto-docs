...
title: Download the Simple RBAC backend
description: Download the Simple RBAC backend API
---

# Download the Simple RBAC back-end

Now that you have tested out the policy, the next step is to download and run the back-end that is included with this sample. It contains an API for interacting with the Citadel resources and is protected by the `simple-rbac` policy instance hosted in Aserto, which we just interacted with.
...
<img src="/quickstart-simple-rbac/simple-rbac-15-server-running.png" />
