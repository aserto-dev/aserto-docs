...
Now that you have learned how to use the Test App, try different users and resoure combinations. Refer to the relationships browser to understand what actions the user should be able to perform depending on the resource.
