...
In [console.aserto.com](https://console.aserto.com), go to the `Policies` tab and click "Create a policy repository"

<img src="/quickstart-react-and-node/add-policy-repo.png" width="500px" />
...
<img src="/quickstart-react-and-node/select-org-and-repo.png" width="500px" />

Finally, name your policy repository "aserto-react" and click "Create a new policy repository".

<img src="/quickstart-react-and-node/name-policy.png" width="500px" />
...
<img src="/quickstart-react-and-node/policy-repos-list.png" width="500px" />

## Create an authorizer instance

To set up an authorizer runtime instance, head to the Authorizer tab and click "Create an authorizer instance":

<img src="/quickstart-react-and-node/add-authorizer.png" width="500px" />
