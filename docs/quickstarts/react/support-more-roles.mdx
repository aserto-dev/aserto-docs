...
In the Aserto console, open the Authorizer tab, click on the `aserto-react` instance and open the Policy Browser. Check that the changes you’ve made are reflected:
