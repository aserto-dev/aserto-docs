...
To get started, let's [add users to your Aserto directory](/docs/quickstarts/javascript/react/adding-users). We'll need these users to test our application and authorization policy.
