...
Let's test our application by first logging out, then logging in again with the email `krisj@acmecrop.com` and the password `V@erySecre#t123!`.
...
![kris-unauthorized](/quickstart-react-and-node/kris-unauthorized.png)
