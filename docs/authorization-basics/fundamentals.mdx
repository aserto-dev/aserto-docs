...
A Policy can reason over a few different types of data - roles, attributes, and relationships. These determine the "style" of authorization:
...
Aserto supports all of these styles, as well as any combination, providing a flexible and extensible system.
