...
A Policy can reason over a few different types of data - roles, attributes, and relationships. These determine the style or Authorization Model:
...
Aserto supports all of these models, as well as any combination, providing a flexible and extensible system.
