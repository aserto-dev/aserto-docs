...
The Aserto roles are described [here](/docs/overview/tenant).
...
:::note
You can set the role for the new user by selecting a value from the dropdown. By default, the user is 
invited to a tenant as a **Member**. Once a new user has accepted an invitation, a Tenant Owner 
