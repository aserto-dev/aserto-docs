...
3. OCI registries: [Open Policy Registry](/docs/aserto-console/connections/setup-opcr) and [GitHub Packages](/docs/aserto-console/connections/setup-ghcr) are supported. In addition, Aserto manages system connections to the Aserto Registry and to the multi-tenant Aserto Authorizer for each tenant.
