...
1. Identity Providers: [Auth0](/docs/aserto-console/connections/setup-auth0), [AWS Cognito](/docs/aserto-console/connections/setup-cognito), [Entra (Azure AD)](/docs/aserto-console/connections/setup-azuread), [Google Workspace](/docs/aserto-console/connections/setup-google.mdx), [LDAP](/docs/aserto-console/connections/setup-ldap.mdx) and [Okta](/docs/aserto-console/connections/setup-okta) (more IDPs will be supported in the future)
