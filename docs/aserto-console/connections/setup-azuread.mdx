...
title: Setting up Azure AD as an Identity Provider
description: Setting up Azure AD as an Identity Provider
---

Follow the steps below to set up Azure AD as an Identity Provider.
