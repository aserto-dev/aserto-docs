...
A **policy instance** is an instance of the decision engine's runtime associated with a tagged version of a policy (or a tag mask). You can create multiple policy instances, each associated with different versions of a policy.
