...
the instructions to [create one](/docs/aserto-console/connections#connecting-a-source-code-provider).
...
automatically be built and pushed to the Aserto Registry. See the [Policy Lifecycle](/docs/overview/policy-lifecycle)
