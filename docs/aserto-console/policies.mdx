...
1. 0 - The _major_ version of the policy. All **minor and patch** versions under this version will be included in this policy. For example, if you create a 0.1 tag, any authorizer instance associated with the `0` tag will reflect the latest minor change.
2. 0.0 - The _minor_ version of the policy. All **patch** versions under this version will be included in this policy. For example, if you create a `0.0.1` tag, any authorizer instance associated with the `0.0` tag will reflect the latest patch change.
3. 0.0.0 - The _patch_ version of the policy. This tells the authorizer instance to use this particular version of the policy - and no other version will be used.
