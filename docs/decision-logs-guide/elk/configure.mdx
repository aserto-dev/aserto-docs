...
example `~/path/files/decision_logs/0116e83a-7e21-11ec-ab5b-00c9e2c2068b`. Then the command line to retrieve new logs
would be:
...
credentials. Furthermore, these examples illustrate one way to combine user information with decision logs as well as
how to leverage resource data.

- [decision_logs.conf](/docs/decision-logs-guide/elk/decision-logs-conf)
- [users.conf](/docs/decision-logs-guide/elk/users-conf)
