...
When running the Edge Authorizer it contains an embedded Aserto Directory which uses an embedded database, based on BoltDB. It scales up to a couple of GB of data (which could house 10k's of users, depending on how many properties each user contains).
