...
- A connection to an [Identity Provider](/docs/aserto-console/connections#connecting-an-identity-provider)
- An Aserto [authorization policy](/docs/getting-started-acmecorp/create-policy)
