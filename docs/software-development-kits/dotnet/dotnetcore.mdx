...
- A connection to an [Identity Provider](/docs/aserto-console/connections/overview)
- An Aserto [authorization policy](/docs/getting-started/peoplefinder/create-policy)
...
Configure the Authorizer API Key, Tenant ID, Policy root and Policy Name and Instance label in the `appsettings.json`:
