...
title: The Satellite Authorizers Architecture - Overview
description: An overview of the Satellite Authorizers architecture
---

# Satellite Authorizers
