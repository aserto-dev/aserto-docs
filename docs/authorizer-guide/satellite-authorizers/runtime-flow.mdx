...
title: Runtime flow
description: Runtime flow of satellite authorizers
---

# Runtime Flow

When the satellite has been bootstrapped it will transition to the runtime flow:

<img src="/discovery-page2.png" />
...
A second time-based background task will synchronize the identity data from the central directory to the satellite when the edge directory plugin is enabled. By default, directory synchronization is turned off and can be enabled in the Aserto console.
