...
The Aserto [JavaScript SPA SDK](/docs/software-development-kits/javascript) and 
[React SDK](/docs/software-development-kits/react ) support this pattern.  Each of these SDKs works together 
