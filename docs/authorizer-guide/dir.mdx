---
sidebar_label: Directory v1
title: Authorizer - dir
description: Documentation for the Directory v1 APIs
---

# Deprecated v1 Directory APIs

:::danger Note
These APIs have been deprecated and replaced by the Directory v2 [graphQL APIs](/docs/directory-guide/scenario.mdx).
:::
