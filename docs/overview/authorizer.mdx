...
title: Conceptual Overview - Authorizer
...
In addition, when you create an Aserto [organization](/docs/overview/organization), an Authorizer instance
...
- [User context](/docs/overview/policy#user-context): a set of user _properties_, _roles_, and _scopes_ that can be used in a policy to determine the outcome of decisions
- [Resource context](/docs/overview/policy#resource-context): additional resource data (often in the form of lookup tables) that is used in determining the outcome of decisions
