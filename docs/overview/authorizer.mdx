...
- [User context](/docs/overview/policy#user-context): a set of user _properties_, _roles_, and _scopes_ that can be used in a policy to determine the value of decisions
