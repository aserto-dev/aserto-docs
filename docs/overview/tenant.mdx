...
[*connections*](/docs/overview/connections), [*policies*](/docs/overview/policy-lifecycle), and the 
[*user directory*](/docs/overview/directory). You can think of it like a GitHub organization.
...
Learn more about how to [manage Aserto tenants](/docs/aserto-console/manage-tenant) using the Aserto Console.