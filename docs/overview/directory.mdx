---
sidebar_label: Aserto Directory
title: Overview - Aserto Directory
...
The Directory defines three concepts:
* Subject: a principal (user, machine, group)
* Object: a resource (organization, team, project, list, document)
* Relation: a named relationship between a subject and an object (member, viewer, editor, admin, owner)
