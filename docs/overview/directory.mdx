...
* *Euan* is a *member* of the *Sales-group* **group**
* The *Sales-folder* **folder** is a *parent* of the *Sales-plan* **document**
* The *Sales-group* **group** is a *viewer* of the *Sales-folder* **folder**
