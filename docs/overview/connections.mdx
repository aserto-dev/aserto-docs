...
- **IDP** (identity provider): this is a read-only connection between Aserto and an Identity Provider. Currently, Auth0, AWS Cognito, Entra (Azure AD), Google Workspace, and Okta are supported.
