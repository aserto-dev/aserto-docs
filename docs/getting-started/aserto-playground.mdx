...
Open the [Aserto playground](https://www.aserto.com/playground). You’ll see the following:

![playground-empty](/getting-started/playground-empty.png)
...
![euan-garden-playground](/getting-started/euan-garden-playground.png)
...
![playground-permissions-1](/getting-started/playground-permissions-1.png)
...
To see the results of the evaluation of the policy, we’ll click the “Evaluate” button:

![evaluate-button](/getting-started/evaluate-button.png)

Let’s look at the results:

![playground-evaluated-results](/getting-started/playground-evaluated-results.png)
...
![playground-evaluated-results-2](/getting-started/playground-evaluated-results-2.png)
...
![playground-put-policy](/getting-started/playground-put-policy.png)
...
![playground-download](/getting-started/playground-download.png)
