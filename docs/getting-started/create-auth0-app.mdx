---
sidebar_label: Create an Auth0 SPA and API
---
...
:::caution Note
The Application Type must be “Single Page Application” and all the URLs (callback URLs, logout URLs, Web Origins, and Origins should be set to 
