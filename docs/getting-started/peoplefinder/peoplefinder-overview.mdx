...
demo application called [PeopleFinder](https://github.com/aserto-demo/peoplefinder-acmecorp),
an application which allows its users to browse a corporate directory, edit their own information,
and if they have the right permissions, edit department and title information for others.
...
- Our sample application, [PeopleFinder](https://github.com/aserto-demo/peoplefinder-acmecorp), cloned to your GitHub account
- Your own copy of the policy repository associated with that sample application, [policy-peoplefinder-rbac](https://github.com/aserto-dev/policy-peoplefinder-rbac), in your GitHub account
...
- A local developer experience (using the Aserto Sidecar), which allows you to run a local copy of the authorizer in a docker container
