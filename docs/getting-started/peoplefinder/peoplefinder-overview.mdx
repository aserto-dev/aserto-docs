...
To follow this Quickstart you'll need to have an Aserto account. If you do not have one, you can create one following the directions [here](https://docs.aserto.com/docs/getting-started/first-steps/create-account). Once you hace created your tenant, you can continue.