...
The Aserto console shows the current loaded policy version for the policy instance you created. If you click the `peoplefinder-rbac` policy instance in the Policies tab, you will see the current set of policy modules.

![console-policy-get](/getting-started/console-policy-get.png)
