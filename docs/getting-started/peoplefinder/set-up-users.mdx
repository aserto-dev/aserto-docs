...
<img
  src="/getting-started/add-a-connection-button.png"
  width="170px"
/>
...
![directory-filter](/getting-started/directory-filter.png)

![euan-garden-card](/getting-started/euan-garden-card.png)
