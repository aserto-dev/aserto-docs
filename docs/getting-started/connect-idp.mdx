---
sidebar_label: Connect the identity provider
---
...
able to click the Directory tab in the Navbar and see your users stream in using the Directory browser.

:::note
Loading users from the Identity Provider into the Aserto Directory is an asynchronous task.
