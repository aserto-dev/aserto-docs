...
The Aserto console shows the current loaded policy version attached to the policy instance you created. If you click the `peoplefinder` policy instance in the Policies tab, you will see the current set of policy modules.
...
- By default, the "Edit" button is both _visible_ and _enabled_
