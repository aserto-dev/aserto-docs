...
The Aserto console shows the current loaded policy for the hosted Authorizer instance for your tenant. If you click the `peoplefinder` policy in the Registry tab, you will see the current set of policy modules.
